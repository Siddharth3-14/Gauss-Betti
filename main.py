...
[PFA_betti0,PD_betti0] = rocGen.BettiROC(Betti0[:,betti_dimension,:],Betti1[:,betti_dimension,:],0.01)     #Generates the Betti ROC curve
[PFA_betti1,PD_betti1] = rocGen.BettiROC(Betti0[:,betti_dimension+1,:],Betti1[:,betti_dimension+1,:],0.01) #Generates the Betti ROC curve
[PFA_Genus,PD_Genus] = rocGen.GenusROC(Genus0,Genus1,0.01)                                                 #Generates the Genus ROC curve

utilities.plotROC(PFA_betti0,PD_betti0,Nsize,iteration,power_index_null,power_index_test,'betti',0)        #Plots the Betti ROC curve
utilities.plotROC(PFA_betti1,PD_betti1,Nsize,iteration,power_index_null,power_index_test,'betti',1)        #Plots the Betti ROC curve
utilities.plotROC(PFA_Genus,PD_Genus,Nsize,iteration,power_index_null,power_index_test,'genus')            #Plots the Genus ROC curve

utilities.saveROC(PFA_betti0,PD_betti0,Nsize,iteration,power_index_null,power_index_test,'betti',0)        #Saves the Betti ROC curve
utilities.saveROC(PFA_betti1,PD_betti1,Nsize,iteration,power_index_null,power_index_test,'betti',1)        #Saves the Betti ROC curve
